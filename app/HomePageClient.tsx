...
export default function HomePageClient() {
  ...
  }, [fadeUpControls, landingControls]);
      ...
      <AnimatePresence mode="wait" initial={false}>
        {!showWelcome ? (
          <motion.section
            ...
            exit={prefersReducedMotion ? undefined : { opacity: 0, scale: 0.9, filter: "blur(10px)" }}
          ...
          >
            ...
            <motion.button
              ...
              whileHover={prefersReducedMotion ? undefined : { scale: 1.05, boxShadow: "0 15px 35px rgba(59, 130, 246, 0.35)" }}
          ...
          <motion.section
            ...
            exit={prefersReducedMotion ? undefined : { x: -120, opacity: 0 }}
            transition={baseTransition}
          ...
          >
            ...
            >
              <Link
                href="/welcome"
                className={`inline-flex items-center gap-3 rounded-full bg-primary px-8 py-3 text-sm font-semibold uppercase tracking-wide text-white shadow-lg transition-transform duration-300 hover:bg-primary/90 ${

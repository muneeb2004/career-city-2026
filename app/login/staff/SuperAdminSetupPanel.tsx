...
export default function SuperAdminSetupPanel({ redirectPath }: SuperAdminSetupPanelProps) {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-text/70">
            No staff users exist yet. Complete this form to provision the first super admin account and access the management dashboard.
          </p>
        </div>
      </div>
